...
正常成年男性比例，气质沉稳厚实、宽肩可靠；整体带有老钟楼维护员的气质，以钟表刻度、旧铜、旧钥匙和皮革边作为集中视觉母题。奇幻感克制，不要大范围发光。
体型壮硕厚实，宽肩厚胸，手臂和腿部有力量，成熟有重量感，边缘略带柔和厚度。
成熟男性脸型，发型简洁可读，平静专注的表情。
整体以都市奇幻劳动者为主，辅以传统现代混合，外套负责主视觉，内搭降低复杂度，只做结构衬托，钟表刻度和旧铜元素集中在外套肩部或领口区域，腰带或下摆边缘的一处小呼应。
基础上衣为立领短褂，H 型轮廓，作为衬托层降低复杂度，重点集中在腰部，用活动褶支撑大形，只轻微呼应钟表刻度。
外套是中等量感的西装外套，宽松轮廓，功能布料配合干净哑光表面；重点集中在帽子和袖子，用大口袋形成外套识别点，系在腰间穿着，不要完全遮住白色贴身上衣。
