...
正常成年男性比例，气质沉稳厚实、宽肩可靠；整体像地下健身和拳馆教练，以厚针织、布带、压力表和地方徽章形成强壮但克制的都市气质。奇幻感克制，不要大范围发光。
体型壮硕厚实，宽肩厚胸，手臂和腿部有力量，成熟有重量感，边缘略带柔和厚度。
成熟男性脸型，发型简洁可读，平静专注的表情。
整体以运动机能为主，辅以传统现代混合，外套负责主视觉，内搭降低复杂度，只做结构衬托，压力表和工具带元素集中在外套肩部或领口区域，腰带或下摆边缘的一处小呼应。
基础上衣为束腰长上衣，倒三角轮廓，作为衬托层降低复杂度，重点集中在肩膀，用侧边扣带支撑大形，只轻微呼应压力表。
外套是中等量感的飞行员夹克，披挂式轮廓，哑光尼龙配合平整大色块表面；重点集中在袖子和口袋，用厚重下摆形成外套识别点，闭合穿着，闭合穿着时可以覆盖大部分内搭。
