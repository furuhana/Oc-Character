...
整体以都市奇幻劳动者为主，辅以传统现代混合，外套负责主视觉，内搭降低复杂度，只做结构衬托，蔷薇和荆棘元素集中在外套肩部或领口区域，腰带或下摆边缘的一处小呼应。
基础上衣为斜襟长上衣，超宽松轮廓，作为衬托层降低复杂度，重点集中在腰部，用束带结构支撑大形，只轻微呼应蔷薇。
外套是中等量感的开衫，A 字轮廓，皮革滚边配合低纹理表面；重点集中在背部和口袋，用披肩层形成外套识别点，闭合穿着，闭合穿着时可以覆盖大部分内搭。
下装使用带前片结构的裤装，下半身厚重轮廓，裁短及踝长度，可搭配工装皮带连接上半身，腿部以功能口袋片和收窄裤脚收束；材质为工装帆布，轻微使用感，视觉重点只放在裤脚和脚踝，只在裤脚和脚踝或裤侧做一处低调主题呼应，复杂度低于上半身，不抢外套主视觉。
